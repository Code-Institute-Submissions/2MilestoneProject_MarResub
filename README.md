...
I have also used the Inspect tool from Google Chrome to test the responsiveness of the website in different size devices and no errors have been shown
at the console. 
